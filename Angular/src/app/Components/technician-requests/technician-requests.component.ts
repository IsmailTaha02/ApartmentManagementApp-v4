...
import { RequestsTopbarComponent } from "../TopBar/requests-topbar/requests-topbar.component";
...
@Component({
  ...
  imports: [CommonModule, HttpClientModule, FormsModule, MaintenanceTopbarComponent, RequestsTopbarComponent]
})
