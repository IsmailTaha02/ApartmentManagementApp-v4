...
import { FindTechnicianTopbarComponent } from "../TopBar/find-technician-topbar/find-technician-topbar.component";
...
@Component({
  ...
  standalone: true,
  imports: [FormsModule, CommonModule, FindTechnicianTopbarComponent]
})
