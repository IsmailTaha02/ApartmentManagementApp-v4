...
import { ProfileTopbarComponent } from "../TopBar/profile-topbar/profile-topbar.component";
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, FormsModule, ProfileTopbarComponent],
...
export class TenantProfileComponent implements OnInit {
  ...
  avatar = signal<string>('icons/profile.png');
