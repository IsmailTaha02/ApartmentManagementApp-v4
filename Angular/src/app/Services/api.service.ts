...
export class ApiService {
  ...
  assignApartment(payload: {
    ...
    return this.http.post('http://localhost:5000/api/assign-apartment', payload);
  }
  
  updateApartmentStatusOnly(apartmentId: number, status: string) {
    return this.http.put(`http://localhost:5000/api/apartments/${apartmentId}/status`, {
      status: status
    });
  }
